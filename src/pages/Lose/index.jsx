...
export default checkLogin(memo(function Lose() {
    ...
    const columns=[
        ...
        },
        {
            ...
            render: (text,record) => (
                <span>
                    {record.goods_type==='0'?'生活用品':record.goods_type==='1'?'学习用品':record.goods_type==='2'?'贵重用品':'证件'}
                </span>
    ...
    return (
        <div>
            ...
            <div className={style.search_area}>
                <Form className={style.searchform} ref={formRef} initialValues={{goods_name:'',type :'',status:''}}>
                    <Form.Item label="商品名" name="goods_name">
                        <Input />
                    </Form.Item>
                    <Form.Item label="状态" name="status" style={{width:'150px',marginLeft:'15px'}}>
                        <Select allowClear>
                            <Option value={'0'}>进行中</Option>
                            <Option value={'1'}>已结束</Option>
                        </Select>
                    </Form.Item>
                    <Form.Item label="分类" name="type"  style={{width:'150px',marginLeft:'15px'}}>
                        <Select allowClear>
            ...
            <Table dataSource={LoseList} columns={columns} rowKey="id" 
                scroll={{ x: 1800 }}
